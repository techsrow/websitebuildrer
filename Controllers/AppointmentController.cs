...
namespace WebsiteBuilder.Controllers
{
...

    {
        ...
        public AppointmentController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, ILogger<LoginViewModel> logger, ApplicationDbContext context, WebsiteConstraintService websiteConstraintService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var services = await _context.GetAppointments
        ...
        public async Task<IActionResult> Create(GetAppointment appoint)
        {
            if (ModelState.IsValid)
            {
                ...
                appoint.WebsiteId = userWebsite?.WebsiteId ?? 0;
