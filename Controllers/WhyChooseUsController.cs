...
namespace WebsiteBuilder.Controllers
{
    public class WhyChooseUsController : Controller
    {
        ...
        public WhyChooseUsController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, ILogger<LoginViewModel> logger, ApplicationDbContext context, WebsiteConstraintService websiteConstraintService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var whychoose = await _context.WhyChooseUs
        ...
        public async Task<IActionResult> Create(WhyChooseUs whychoose, IFormFile imageFile)
        {
            if (ModelState.IsValid)
            {
                ...
                whychoose.WebsiteId = userWebsite?.WebsiteId ?? 0;
                ...
                whychoose.Photo = $"/img/slider/{imageName}";

                _context.Add(whychoose);
