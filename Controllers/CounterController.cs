...
namespace WebsiteBuilder.Controllers
{
    ...
    public class CounterController : Controller
    {
        ...
        public CounterController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, ILogger<LoginViewModel> logger, ApplicationDbContext context, WebsiteConstraintService websiteConstraintService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var counter = await _context.Couters
        ...
        public async Task<IActionResult> Create(Couter counter)
        {
            if (ModelState.IsValid)
            {
                ...
                counter.WebsiteId = userWebsite?.WebsiteId ?? 0;
